                                    ...
                                    <td class="px-6 py-4 text-sm font-medium">
                                        <div class="flex items-center gap-3">
                                            ...
                                            @hasanyrole('Jefe|PM|PO|Programador')
                                                ...
                                                @hasrole('Jefe')
                                                <form method="POST" action="{{ route('entregables.destroy', $entregable) }}" class="inline">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" data-confirmar="¿Querés eliminar este entregable? Esta acción no se puede deshacer."
