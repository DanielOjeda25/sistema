                    ...
                    <div class="px-6 py-2 divide-y divide-gray-100">
                        <div class="flex items-center gap-3 py-3.5">
                            ...
                            <div class="min-w-0">
                                ...
                                <p class="text-sm font-medium text-gray-800 truncate" x-text="detalle.email"></p>
                            </div>
                        </div>
                        <div class="flex items-center gap-3 py-3.5">
                            <span class="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-emerald-50 text-[#008c63]">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-medium text-gray-800" x-text="detalle.telefono"></p>
                            </div>
                        </div>
                        <div class="flex items-center gap-3 py-3.5">
                            <span class="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-emerald-50 text-[#008c63]">
                            ...
                            <div class="min-w-0">
                                ...
                                <p class="text-sm font-medium text-gray-800 truncate" x-text="detalle.empresa"></p>
                            </div>
                        </div>
                        <div class="flex items-center gap-3 py-3.5">
                            <span class="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-emerald-50 text-[#008c63]">
                            ...
                            <div>
                                ...
                                <span class="mt-1 inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold"
                                    :class="detalle.estado === 'activo' ? 'bg-emerald-100 text-emerald-700' : 'bg-red-100 text-red-700'"
                                    x-text="detalle.estado === 'activo' ? 'Activo' : 'Inactivo'"></span>
                            </div>
                        </div>
                    </div>
