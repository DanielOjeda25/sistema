            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('facturas.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="monto" name="monto" type="number" step="0.01" min="0" max="10000000" class="mt-1 block w-full" :value="old('monto')" required />
                        <x-input-error class="mt-2" :messages="$errors->get('monto')" />
                    </div>

                    <div>
                        <x-input-label for="fecha_emision" value="Fecha de Emisión (DD/MM/AAAA)" />
                        <x-text-input id="fecha_emision" name="fecha_emision" type="date" lang="es-AR" autocomplete="off" class="mt-1 block w-full" :value="old('fecha_emision')" required />
                    ...
                    <div>
                        ...
                        <x-text-input id="fecha_vencimiento" name="fecha_vencimiento" type="date" lang="es-AR" autocomplete="off" class="mt-1 block w-full" :value="old('fecha_vencimiento')" />
